                  ...
                  <ul class="glide__slides">
                    ...
                    <li class="glide__slide" style="padding-right: 30px !important">
                      <div class="info text-left" style="height: 100% !important; width: auto !important;">
                        ...
                        <p class="description px-2 py-2">
                          No se te cobrará el envío al momento de pagar tus productos. <br><br> Es recién luego de tu compra, cuando ya tengamos tus datos necesarios para el envío, que te daremos un botón, o QR, de pago de MercadoPago para pagar el envío y recibir la compra en tu casa gracias a MercadoEnvíos.
                        </p>
                      </div>
                    </li>
                    <li class="glide__slide" style="padding-right: 30px !important">
