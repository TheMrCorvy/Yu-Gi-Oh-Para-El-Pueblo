        ...
        <div class="my-5">
            <div class="container">
                            ...
                            <tbody>
                                @foreach ($compras as $compra)    
                                    <tr>
                                        ...
                                        <td class="text-right">${{ $compra->precio_unidad }}</td>
                                        <td class="text-right">${{ $compra->precio_unidad * $compra->unidades_compradas }}</td>
                ...
                <div class="col-lg-12 mt-5 d-flex justify-content-end">
                    <p class="mr-8"><strong>Fecha: {{ $ordenDeCompra->fecha }}</strong> <small class="text-muted">(Año-Mes-Día)</small>.</p>
                    <p><strong>Monto Total: $ {{ $ordenDeCompra->monto_total }}.</strong></p>
                </div>      
                <div class="col-lg-12 d-flex justify-content-end">
                    <small class="text-muted">Es posible que el monto total y la suma de los precios no coincida. Esto puede ser por que el usuario consumió un cupón de descuento.</small>
                </div>   
                    ...
                    <div class="col-lg-12 row d-flex justify-content-center">
                        <table class="table">
                            <thead>
                                <tr>
                                    <th>Nombre</th>
                                    <th>Calle Principal <small>(Incluyendo departamento, piso, timbre, etc.)</small></th>
                ...
                <div class="col-lg-12 card card-plain" style="margin-top: -50px !important;">
                    ...
                    <div class="card-body">
                        <p><strong class="text-capitalize">{{ $ordenDeCompra->nombre }}</strong> - DNI o CUIL <strong class="text-capitalize">{{ $ordenDeCompra->dni }}</strong></p>
                        <p><strong class="text-capitalize">{{ $ordenDeCompra->calle }}</strong>, <strong class="text-capitalize">{{ $ordenDeCompra->altura }}</strong> - C.P.: <strong>{{ $ordenDeCompra->codigo_postal }}</strong>, <strong class="text-capitalize">{{ $ordenDeCompra->ciudad }}</strong>, <strong class="text-capitalize">{{ $ordenDeCompra->provincia }}</strong></p>
                    </div>
                </div>
